    ...
    <footer className="bg-[#0a1628] text-white">
      <div className="container-custom pt-14 pb-0">
        ...
        <div className="grid gap-12 border-b border-white/8 pb-12 md:grid-cols-[2.2fr_1fr_1fr]">
          ...
          {/* Platform + Company */}
          <div>
            <p className="mb-4 text-xs font-semibold uppercase tracking-widest text-white/35">{t('platform')}</p>
            <div className="flex flex-col gap-2.5">
              <Link href={`/${locale}/opportunities`} className="text-sm text-white/60 transition hover:text-white">{t('opportunities')}</Link>
              <Link href={`/${locale}/dashboard`} className="text-sm text-white/60 transition hover:text-white">{t('dashboard')}</Link>
              <Link href={`/${locale}/add-opportunity`} className="text-sm text-white/60 transition hover:text-white">{t('addOpportunity')}</Link>
              <Link href={`/${locale}/saved`} className="text-sm text-white/60 transition hover:text-white">{t('saved')}</Link>
            </div>

            <p className="mb-4 mt-6 text-xs font-semibold uppercase tracking-widest text-white/35">{t('company')}</p>
            <div className="flex flex-col gap-2.5">
              <Link href={`/${locale}/about`} className="text-sm text-white/60 transition hover:text-white">{t('about')}</Link>
              <Link href={`/${locale}/contact`} className="text-sm text-white/60 transition hover:text-white">{t('contact')}</Link>
            </div>
          </div>

          {/* Categories + Contact */}
          <div>
            <p className="mb-4 text-xs font-semibold uppercase tracking-widest text-white/35">{t('categories')}</p>
            <div className="flex flex-col gap-2.5">
              <Link href={`/${locale}/opportunities`} className="text-sm text-white/60 transition hover:text-white">{t('jobs')}</Link>
              <Link href={`/${locale}/opportunities`} className="text-sm text-white/60 transition hover:text-white">{t('internships')}</Link>
              <Link href={`/${locale}/opportunities`} className="text-sm text-white/60 transition hover:text-white">{t('scholarships')}</Link>
              <Link href={`/${locale}/opportunities`} className="text-sm text-white/60 transition hover:text-white">{t('remote')}</Link>
              <Link href={`/${locale}/opportunities`} className="text-sm text-white/60 transition hover:text-white">{t('training')}</Link>
              <Link href={`/${locale}/opportunities`} className="text-sm text-white/60 transition hover:text-white">{t('volunteer')}</Link>
            </div>

            <p className="mb-4 mt-6 text-xs font-semibold uppercase tracking-widest text-white/35">{t('contactUs')}</p>
            <div className="flex flex-col gap-2.5">
        ...
        <div className="flex items-center gap-3 flex-wrap border-b border-white/6 py-4">
          <span className="text-xs font-medium uppercase tracking-widest text-white/30">{t('builtWith')}</span>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 py-5">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs text-white/30 transition hover:text-white/60 cursor-pointer">{t('terms')}</span>
            <span className="text-xs text-white/30">
              {t('madeWith')} <span className="text-red-400">♥</span> {t('inHerat')}
            </span>
          </div>
        </div>
