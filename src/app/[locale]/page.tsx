    ...
    <main className="relative min-h-screen overflow-hidden bg-[var(--color-background)]">
      ...
      <section className="container-custom flex min-h-[calc(100vh-80px)] items-center justify-center">
        <div className="max-w-3xl text-center">
          ...
          <div className="mb-6 mt-6 inline-flex items-center gap-2 rounded-full border border-[#a8d8df] bg-[#d1eef2] px-4 py-2 text-sm font-medium text-[var(--color-primary-dark)]">
          ...
          <p className="mx-auto mt-6 max-w-xl text-base text-[var(--color-text-secondary)] md:text-lg">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-4 md:flex-row">
            <Link
              href="/opportunities"
              className="inline-flex items-center gap-2 rounded-xl bg-[var(--color-primary-dark)] px-8 py-3.5 text-base font-semibold text-white shadow-md transition hover:opacity-90"
            >
            ...
            <Link
              href="/about"
              className="inline-flex items-center gap-2 rounded-xl bg-white px-8 py-3.5 text-base font-semibold text-[var(--color-primary-dark)] shadow-md ring-2 ring-[var(--color-primary-dark)] transition hover:bg-[#d1eef2]"
            >
              Learn More
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-3">
            <div className="flex items-center gap-3 rounded-2xl border border-[#d1eef2] bg-white px-4 py-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#d1eef2] text-[var(--color-primary-dark)]">
            ...
            <div className="flex items-center gap-3 rounded-2xl border border-[#fde68a] bg-white px-4 py-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#fef3c7] text-yellow-700">
            ...
            <div className="flex items-center gap-3 rounded-2xl border border-[#ddd6fe] bg-white px-4 py-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#ede9fe] text-purple-700">
            ...
            <div className="flex items-center gap-3 rounded-2xl border border-[#a7f3d0] bg-white px-4 py-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#d1fae5] text-green-700">
